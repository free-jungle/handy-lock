package com.github.free.monkey.handy.lock.examples.service.impl;

import java.io.IOException;
import java.util.concurrent.TimeUnit;
import javax.annotation.Resource;

import com.github.free.monkey.handy.lock.core.LockFailException;
import com.github.free.monkey.handy.lock.core.RedisDistributedLockable;
import com.github.free.monkey.handy.lock.core.RedisLock;
import com.github.free.monkey.handy.lock.core.RedisLockManager;
import com.github.free.monkey.handy.lock.examples.service.IRedisOpService;
...
public class RedisOpService implements IRedisOpService {
    ...
    @Override
    @RedisDistributedLockable(key = "com.github.tousy.lock.examples.service.impl.lockUseAnnotation",
    ...
    @Override
    @RedisDistributedLockable(key = "com.github.tousy.lock.examples.service.impl.lockUserAnnotationWithTryCount",
    ...
    @Override
    @RedisDistributedLockable(keySpel = "'com.github.tousy.lock.examples.service.impl.lockUserAnnotationWithSpel#'+#id",
